...
class CreateStudentScoringPeerTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('student_scoring_peer', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('student_scoring_peer');
    }
}
