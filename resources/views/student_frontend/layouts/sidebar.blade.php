        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <div class="col-md-10 col-10 center" style="text-align: center">
                    <p class="user-title">歡迎 {{auth('student')->user()->name}} 使用 ᐠ( ᐛ )ᐟ</p>
                </div>
                ...
                <li class="has_sub">
                    <a href="{{action('StuGroupListController@index')}}" class="waves-effect"><i class="fa fa-users"></i> <span> 小組專區 </span> </a>
                </li>
