    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            ...
            <ul>
                ...
                <li class="has_sub">
                    <a href="{{action('ImportStudentController@index')}}" class="waves-effect"><i class="fa fa-user"></i> <span> 成員名單 </span> </a>
                </li>
                ...
                <li class="has_sub">
                    <a href="{{action('MeetingController@index')}}" class="waves-effect"><i class="fa fa-cog"></i> <span> 會議管理 </span> </a>
                </li>
                ...
                <li class="has_sub">
                    <a href="{{action('TranscriptController@index')}}" class="waves-effect"><i class="fa fa-search"></i> <span> 成績查詢 </span> </a>
                </li>
